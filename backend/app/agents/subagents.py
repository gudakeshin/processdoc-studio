...
from app.agents.pptx_slide_batching import (
    _generate_slides_batched,
    _slides_from_outline_fallback,
...
# Batched slide generation lives in app.agents.pptx_slide_batching (re-imported above).
